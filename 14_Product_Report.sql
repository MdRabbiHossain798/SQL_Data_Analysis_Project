...
Highlights:
	...
	2.Segments products by revenue to indentify High-Performers, Mid-Range, or Low-Performers.
...
-- Product Aggrigation: Summarizes key metrics at the product level
SELECT 
product_key,
product_name,
category,
